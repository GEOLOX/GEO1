...
import { Briefcase, Zap, GitBranch, Cloud } from 'lucide-react';

export default function BrandsSection() {
    const brands = [
        { name: 'QuantumLeap', icon: Briefcase },
        { name: 'StellarForge', icon: Zap },
        { name: 'ApexIndustries', icon: GitBranch },
        { name: 'NovaCloud', icon: Cloud },
        { name: 'ZenithCorp', icon: Briefcase },
    ];
